...
//     );
//     this.plugin.addProject(lang, [PluginGameType.KK], PluginResolver.VisualStudio, "KK_Fix_CameraTarget");
//     this.plugin.addProject(lang, [PluginGameType.PH], PluginResolver.VisualStudio, "PH_Fix_CameraTarget");
//     this.plugin.addProject(lang, [PluginGameType.AI], PluginResolver.VisualStudio, "AI_Fix_CameraTarget");
//     this.plugin.addProject(lang, [PluginGameType.HS2], PluginResolver.VisualStudio, "HS2_Fix_CameraTarget");
//   }
...
//     );
//     this.plugin.addProject(lang, [PluginGameType.PH], PluginResolver.VisualStudio, "PH_Fix_ResourceUnloadOptimizations");
//     this.plugin.addProject(lang, [PluginGameType.KK], PluginResolver.VisualStudio, "KK_Fix_ResourceUnloadOptimizations");
//     this.plugin.addProject(lang, [PluginGameType.HS1], PluginResolver.VisualStudio, "HS_Fix_ResourceUnloadOptimizations");
//     this.plugin.addProject(lang, [PluginGameType.AI], PluginResolver.VisualStudio, "AI_Fix_ResourceUnloadOptimizations");
//     this.plugin.addProject(lang, [PluginGameType.HS2], PluginResolver.VisualStudio, "HS2_Fix_ResourceUnloadOptimizations");
//   }
